  ...
  return (
    <div className="mx-auto grid max-w-6xl gap-12 px-6 py-16 md:grid-cols-[0.9fr_1.1fr] md:items-center md:py-24">
      <div className="relative order-2 flex min-h-[320px] flex-col justify-between overflow-hidden rounded-sm bg-ink p-8 shadow-panel-lg md:order-1 md:min-h-[460px] md:p-10">
        <p className="manifest-label text-paper/50">Where it started</p>
        ...
        <div className="flex items-center gap-3 text-paper/60">
          <span className="manifest-label text-paper/60">NY / NJ / CT</span>
          <span className="route-rule flex-1 opacity-40" />
          <span className="manifest-label text-brass-light">Florida</span>
        </div>
      </div>
