  ...
  return (
    <Link
      ...
      className={[
        ...
        "fixed left-4 z-50 flex items-center gap-2 rounded-full bg-brass/80 brightness-95 px-5 py-3 font-display text-sm font-semibold uppercase tracking-wideish text-paper transition-transform duration-150 ease-out hover:-translate-y-0.5 hover:bg-brass-dark active:translate-y-0 active:scale-[0.98] sm:left-6",
